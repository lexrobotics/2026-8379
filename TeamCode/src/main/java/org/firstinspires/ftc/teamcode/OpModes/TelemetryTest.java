 ...
 */
@TeleOp(name = "sensor testing", group = "Sensor")
public class TelemetryTest extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        // I2cDeviceSynch sensorI2C = hardwareMap.get(I2cDeviceSynch.class, "sensor_otos");
        myOtos = hardwareMap.get(SparkFunOTOS.class, "sensor_otos");;
        myOtos.initialize(); // or begin(), depending on the library
