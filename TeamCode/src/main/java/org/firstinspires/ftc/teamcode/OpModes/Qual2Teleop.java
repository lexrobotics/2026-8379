...
@TeleOp(name = "Qual2Teleop", group = "TeleOp")
...
public class Qual2Teleop extends LinearOpMode {
    ...
    public void robot(){
        ...
        // BACKUP - fake outtake cycle (no rpm since this is w/o encoders and I didn't include intake/trans stuff)
        if (gamepad2.y){
            driveTrain();
            // flywheel encoder stuff to get RPM
            TPS = flywheel.getVelocity();
